    ...
    <div class="container my-3" style="border: 2px outset green;">
        ...
        <div class="invoice mb-3">
            <div class="row mb-3 p-3">
                <div class="col-6">
                    <h3 style="color:purple"><b>Apood</b></h3>
                </div>
                <div class="col-6">
                ...
                <div class="col-6">
                    <br><br>
                    <p class="mb-0"><b>Nomor Order:</b> <?php echo "#".$order['o_id']; ?></p>
                    <?php $cDate = strtotime($order['success-date']); ?>
                    <p class="mb-0"><b>Tanggal Order:</b> <?php echo date('d-M-Y',$cDate); ?></p>
                    <p class="mb-0"><b>Pembayaran:</b> Cash On Delivery</p>
                </div>

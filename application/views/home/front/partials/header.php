...
<head>
    ...
    <title>Catering Dapur Defa</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-light bg-light sticky-top">
        <div class="container-fluid">
            <a class="navbar-brand" href="<?php echo base_url().'home/index';?>"></i>Catering Dapur Defa</a>
            ...
            <div class="collapse navbar-collapse" id="navbarRes">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="<?php echo base_url().'restaurant/index';?>">Paket</a>
                    </li>
                    ...
                    <li class="nav-item dropdown active">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <hr>
                            <a class="dropdown-item" href="<?php echo base_url().'orders/';?>"><i class="fas fa-shopping-bag"></i> Order</a>
                            <hr>
                            <a class="dropdown-item" href="<?php echo base_url().'login/logout';?>"><i class="fas fa-power-off"></i> Logout</a>
                        </div>
                    </li>
                    <li class="nav-item active">
                        <a class="nav-link" href="<?php echo base_url().'cart';?>"><i class="fas fa-cart-arrow-down"></i>Keranjang Saya</a>
                    </li>
                    <?php } ?>
                </ul>
            </div>

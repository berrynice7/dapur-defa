...
<div class="container">
    ...
    <div class="table-responsive-sm">
        <table class="table table-striped table-hover">
            ...
            <tfoot>
                <tr>
                    <td><a href="<?php echo base_url().'restaurant' ?>" class="btn btn-sm btn-warning"><i class="fas fa-angle-left"></i> Batal Pesanan</a></td>
                    <td colspan="3"></td>
                    <?php  if($this->cart->total_items() > 0) { ?>
                    <td class="text-left">Total Pesanan: <b><?php echo 'Rp'.$this->cart->total();?></b></td>

        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarRes">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="<?php echo base_url() . 'paket'; ?>">Paket</a>
                    </li>
                    ...
                    <?php } else { ?>
                        <li class="nav-item dropdown active">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <hr>
                                <a class="dropdown-item" href="<?php echo base_url() . 'orders/'; ?>"><i
                                        class="fas fa-shopping-bag"></i> Order</a>
                                <hr>
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="<?php echo base_url() . 'cart'; ?>"><i
                                    class="fas fa-cart-arrow-down"></i>Keranjang Saya</a>
                        </li>
                    <?php } ?>
                </ul>
            </div>

...
<body class="hold-transition register-page">
  <div class="register-box">
    <div class="register-logo">
      <a href=<?php echo base_url("home")?>><b>Catering</b>MamaDefa</a>
    </div>
    ...
    <div class="card">
      <div class="card-body register-card-body">
        ...
        <form action="<?= base_url("auth_pelanggan/register") ?>" method="post">
          <div class="mb-3">
            <div class="input-group">
              <input type="text" class="form-control" placeholder ="Full name" name="nama_pelanggan">
          ...
          <div class="mb-3">
            <div class="input-group">
              <input type="text" class="form-control" placeholder="Phone" name="no_telp">
              <div class="input-group-append">
                <div class="input-group-text">
                  <span class="fas fa-envelope"></span>
                </div>
        ...
        <p class="mb-0 text-center mt-2">
          <a href=<?php echo base_url("auth_pelanggan") ?> class="text-center">I already have account</a>
        </p>
      </div>
    </div><!-- /.card -->
  </div>
